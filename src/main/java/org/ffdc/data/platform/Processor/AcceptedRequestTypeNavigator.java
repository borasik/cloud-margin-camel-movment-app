...
@Component
public class AcceptedRequestTypeNavigator implements Processor {
    ...
    private static final Logger Log = LoggerFactory.getLogger(AcceptedRequestTypeNavigator.class);      
